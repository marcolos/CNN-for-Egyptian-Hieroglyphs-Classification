...
def get_xception():
    path_history = "/Users/marco/Desktop/risultati/Xception/history_train.npy"
    history = np.load(path_history, allow_pickle='TRUE').item()
    
    path_history_test = "/Users/marco/Desktop/risultati/Xception/history_test.npy"
...
def xception_train_val_test():
    history, history_test = get_xception()
    ...
    #ax1.set_title('Xception - model accuracy')
    ...
    #ax2.set_title('Xception - model loss')
